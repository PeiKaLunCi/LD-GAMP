...
if height_img>50:
    test_im_name = "/home/CHEN_QUN/Work/D-AMP_Toolbox-master/LDAMP_TensorFlow/TrainingData/StandardTestData_" + str(height_img) + "Res.npy"
else:
    test_im_name = "/home/CHEN_QUN/Work/D-AMP_Toolbox-master/LDAMP_TensorFlow/TrainingData/TestData_patch" + str(height_img) + ".npy"
...
batch_x_test = np.reshape(I_array, newshape = (-1, 1))
